...
namespace UF
{
    ...
    struct PlayerData : public IsUpdateFieldStructureTag, public HasChangesMask<161>
    {
        ...
        UpdateFieldArray<UF::QuestLog, 100, 35, 36> QuestLog;
    ...
    struct ActivePlayerData : public IsUpdateFieldStructureTag, public HasChangesMask<1455>
    {
        ...
        UpdateFieldArray<DynamicUpdateField<UF::Research, -1, -1>, 1, 20, 21> Research;
        ...
        UpdateFieldArray<UF::RestInfo, 2, 461, 462> RestInfo;
        ...
        UpdateFieldArray<UF::PVPInfo, 6, 551, 552> PvpInfo;
